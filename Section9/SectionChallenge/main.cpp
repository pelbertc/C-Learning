...
/*The main goal of this case is to be able to make selection and would modify the vector 
 * List the vector
 * Add numbers to vector
 * Get the average of the vector
 * Print the smallest number in the vector
 * Print the largest number in the vector
 * Delete all the numbers in the vector
 * */
 
//what I learn here is when you printing output from a loop after a calculation you MUST print it outside of the for loop bracket
//its okay if you want to print out the whole vector, but if you looking for printing of a single outcome value of a calculation
//you must print the output outside of the loop